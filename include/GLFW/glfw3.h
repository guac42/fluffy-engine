 ...
 *  while raw motion is better for controlling for example a 3D player.  Because
 ...
 *
 *  __Do not use this function__ to implement things like player controls.  GLFW
